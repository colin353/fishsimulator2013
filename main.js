...
(function() {
  var CoolTool, Coral, FeedTool, Fish, FishTankCanvasController, GImage, GInputEvent, GMap, OverlayCanvasController, SpongeTool, Tank, ViewController, WarmTool, isMobileSafari, sync_get, tick, viewcontroller,
    __slice = [].slice;
