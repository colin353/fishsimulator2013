...
(function() {
  var BuyMenuController, CoolTool, Coral, FeedTool, Fish, FishTankCanvasController, GImage, GInputEvent, GMap, HandTool, OverlayCanvasController, SaltTool, SpongeTool, Tank, ViewController, WarmTool, isMobileSafari, sync_get, tick, viewcontroller,
    __slice = [].slice;
