...
(function() {
  var BuyMenuController, BuyTool, CoolTool, Coral, FeedTool, Fish, FishTankCanvasController, GImage, GInputEvent, GMap, HandTool, OverlayCanvasController, SaltTool, SpongeTool, Tank, ViewController, WarmTool, isMobileSafari, md5, sync_get, tick, viewcontroller,
    _this = this,
    __slice = [].slice;
