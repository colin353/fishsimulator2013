...
(function() {
  var BuyMenuController, BuyTool, CoolTool, Coral, FeedTool, Fish, FishTankCanvasController, GImage, GInputEvent, GMap, HandTool, OverlayCanvasController, Pellet, SaltTool, SiphonTool, SpongeTool, Tank, ViewController, WarmTool, WaterTool, isMobileSafari, md5, sync_get, tick, viewcontroller,
    _this = this,
    __slice = [].slice;
